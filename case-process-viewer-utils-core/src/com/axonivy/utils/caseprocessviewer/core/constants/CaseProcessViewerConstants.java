package com.axonivy.utils.caseprocessviewer.core.constants;

public class CaseProcessViewerConstants {
  public static final String HYPHEN_SIGN = "-";
  public static final String AND = "&";
  public static final String CASE_PROCESS_VIEWER_CMS_PATH = "case-process-viewer";
